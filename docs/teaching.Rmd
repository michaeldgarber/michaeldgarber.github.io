...
## R for GIS
A wealth of excellent teaching material covering R and R for GIS exists on the internet (e.g., https://geocompr.robinlovelace.net/, https://r-spatial.github.io/sf/, and many, many more.) Our goal with these sessions was not to re-create this material but rather to bring these resources to the attention of our colleagues at CDC and illustrate combinations of packages and functions that we have found especially useful for the management, analysis, and visualization of spatial data relevant for public health.
